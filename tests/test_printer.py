...
class TestESRPrinter(unittest.TestCase):
    ...
    def test_print_IdentityMorphism(self):
        ...
        self.assertEqual(
            self.printer._print_IdentityMorphism(Morphism()), "IdentityMorphism(domain)"
        )
    ...
    def test_print_NamedMorphism(self):
        ...
        self.assertEqual(
            self.printer._print_NamedMorphism(Morphism()),
    ...
    def test_print_Category(self):
        ...
        self.assertEqual(
            self.printer._print_Category(Category()), 'Category("category")'
        )
    ...
    def test_print_BaseScalarField(self):
        class CoordSys:
            symbols: ClassVar[list] = [
                type("Symbol", (object,), {"name": "x"})(),
    ...
    def test_print_Differential(self):
        ...
        self.printer._print = lambda x: str(x)
        self.assertEqual(
            self.printer._print_Differential(DiffWithoutCoordSys()), "d(field)"
        )
    ...
    def test_print_AppliedBinaryRelation(self):
        ...
        self.printer._print = lambda x: str(x)
        self.assertEqual(
            self.printer._print_AppliedBinaryRelation(Expr()), "rel(lhs, rhs)"
        )
    ...
    def test_print_AccumulationBounds(self):
        ...
        self.printer._print = lambda x: str(x)
        self.assertEqual(
            self.printer._print_AccumulationBounds(AccumBounds()),
            "AccumBounds(min, max)",
        )
    ...
    def test_print_Lambda(self):
        ...
        self.printer._print = lambda x: str(x)
        self.assertEqual(
            self.printer._print_Lambda(Lambda()), "Lambda(Signature, expr)"
        )
    ...
    def test_print_LatticeOp(self):
        ...
        self.printer._print = lambda x: str(x)
        self.assertEqual(
            self.printer._print_LatticeOp(LatticeOp()), "LatticeOpFunc(arg1, arg2)"
        )
    ...
    def test_print_Limit(self):
        ...
        self.assertEqual(
            self.printer._print_Limit(LimitWithDir()), "Limit(e, z, z0, dir='-')"
        )
    ...
    def test_print_MatrixSlice(self):
        ...
        self.assertEqual(
            self.printer._print_MatrixSlice(expr), "parenthesized[1:5:2, 2:8:2]"
        )
        ...
        expr = MockExpr(
            MockParent(10, 10), [1, 5, 1], [2, 8, 1]
        )  # Added default step value
        self.assertEqual(
            self.printer._print_MatrixSlice(expr), "parenthesized[1:5, 2:8]"
        )
    ...
    def test_print_Integral(self):
        ...
        self.assertEqual(
            self.printer._print_Integral(expr), "Integral(x*y, (x, 0, 1), (y, 0, 1))"
        )
